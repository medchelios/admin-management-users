...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests()
        ...
        .antMatchers("/api/users/validateAccount/**", "/api/users/updateUserPass/**", "/api/users/updateUser/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
         .antMatchers("/appUsers/**", "/appRoles/**", "/api/users/**").hasAnyAuthority("ROLE_ADMIN")
